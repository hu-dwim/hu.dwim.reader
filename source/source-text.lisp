...
"
  (let* ((inst   (handler-case  (apply (function make-instance)
                                       (list* class
...
"
  (multiple-value-bind (okp value)
      (reader::parse-token token)
    (values t
            (if okp
                (etypecase value
                  (number (building-source-object *stream*  *start* 'source-number
                                                  :value  value))
                  (symbol (building-source-object *stream*  *start* 'source-symbol
                                                  :value  value)))
                (building-source-object *stream*  *start* 'source-token
...
(defclass source-symbol (source-object)
  ((value     :accessor source-symbol-value
              :initarg :value)))
